...
int main(int argc, char *argv[])
{
	...
	{
		std::cout << "Incorrect launch parameters." << std::endl;
	}	
	else
	{
		int qualityX = 38;
		...
		PointCreator pcTEMP = PointCreator(1000, winHei, qualityX, qualityY, seed, colorQuality, imageTitle, renderer, false);
		PointCreator pc = PointCreator((int)(winHei * pcTEMP.returnRatio()), winHei, qualityX, qualityY, seed, colorQuality, imageTitle, renderer, true);
